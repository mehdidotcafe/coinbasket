...
**Project:** coinbasket
**Date Initialized:** November 23, 2025

---

## 1. Project Assessment
- Review codebase structure and dependencies
- Identify legacy components and technical debt
- List modernization targets

## 2. Modernization Goals
- Refactoring objectives
- Migration plans (e.g., Python version, frameworks)
- Test coverage improvements
- CI/CD integration
- Documentation updates

## 3. Workflow Steps
1. Inventory existing services, modules, and dependencies
2. Prioritize modernization tasks
3. Plan incremental refactoring (module-by-module)
4. Add/Improve automated tests
5. Set up automation scripts for repetitive tasks
6. Integrate with CI/CD pipelines

## 4. Tracking & Reporting
- **Completed Tasks:**
  - [ ] Example: Refactored `protocol/asset.py`
- **Pending Tasks:**
  - [ ] Example: Add tests for `data_agent/ingestion/ingest_data_use_case.py`
- **Blockers/Risks:**
  - [ ] Example: Legacy dependency in `invest_agent/database/`
- **Decisions:**
  - [ ] Example: Migrated to Poetry for dependency management

## 5. Documentation & Communication
- Update this guide as tasks progress
- Record key decisions and lessons learned
- Link to related documentation and scripts

---

*This template is auto-generated by the Brownfield Modernization Analyst Agent. Update sections as you progress through the workflow.*
