import type { Basket } from '@/asset/Basket'

export const aiBasket: Basket = {
  id: '50041f0f-dc5f-4d3d-9029-538ad1a794b4',
  name: 'AI',
  displayName: 'AI',
  ticker: 'AI',
  ...
  address: '0xAiBasketAddress000000000000000000000000',
  categories: ['thematic', 'technology', 'ai'],
  decimals: 18,
  type: 'BASKET',
