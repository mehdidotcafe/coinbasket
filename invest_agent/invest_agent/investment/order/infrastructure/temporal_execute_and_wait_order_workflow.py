        ...
        try:
            ...
            await workflow.execute_activity(
                ...
                OnOrderSuccessRequest(
                    id=order_request.id,
                    executed_sell_amount_atomic=executed_atomic_amounts['executed_sell_amount_atomic'],
                    executed_buy_amount_atomic=executed_atomic_amounts['executed_buy_amount_atomic'],
